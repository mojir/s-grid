...
export class Color {
  ...
  public static fromHex(hex: string): Color {
    if (!hexRegExp.test(hex)) {
      useLogger().createLogger('Color').error('Invalid hex color', hex)
  ...
  public static fromHsl(h: number, s: number, l: number, a?: number): Color {
    ...
    if (h < 0 || h > 360 || s < 0 || s > 100 || l < 0 || l > 100 || a < 0 || a > 1) {
      useLogger().createLogger('Color').error('Invalid HSL color', h, s, l, a)
      return new Color(0, 0, 0, 0)
    }
  ...
  public static fromRgb(r: number, g: number, b: number, a?: number): Color {
    ...
    if (r < 0 || r > 255 || g < 0 || g > 255 || b < 0 || b > 255 || a < 0 || a > 1) {
      useLogger().createLogger('Color').error('Invalid RGB color', r, g, b, a)
      return new Color(0, 0, 0, 0)
    }
